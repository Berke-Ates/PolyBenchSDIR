module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %3 = memref.alloc() : memref<1200x1000xf64>
    %4 = memref.alloc() : memref<1200x1000xf64>
    %5 = memref.cast %1 : memref<1xf64> to memref<?xf64>
    %6 = memref.cast %0 : memref<1xf64> to memref<?xf64>
    %7 = memref.cast %2 : memref<1200x1200xf64> to memref<?x1200xf64>
    %8 = memref.cast %3 : memref<1200x1000xf64> to memref<?x1000xf64>
    %9 = memref.cast %4 : memref<1200x1000xf64> to memref<?x1000xf64>
    call @init_array(%c1200_i32, %c1000_i32, %5, %6, %7, %8, %9) : (i32, i32, memref<?xf64>, memref<?xf64>, memref<?x1200xf64>, memref<?x1000xf64>, memref<?x1000xf64>) -> ()
    ...
    %13 = memref.cast %3 : memref<1200x1000xf64> to memref<?x1000xf64>
    %14 = memref.cast %4 : memref<1200x1000xf64> to memref<?x1000xf64>
    call @kernel_syr2k(%c1200_i32, %c1000_i32, %10, %11, %12, %13, %14) : (i32, i32, f64, f64, memref<?x1200xf64>, memref<?x1000xf64>, memref<?x1000xf64>) -> ()
    ...
    scf.if %16 {
      %17 = memref.cast %2 : memref<1200x1200xf64> to memref<?x1200xf64>
      call @print_array(%c1200_i32, %17) : (i32, memref<?x1200xf64>) -> ()
    }
    memref.dealloc %2 : memref<1200x1200xf64>
    memref.dealloc %3 : memref<1200x1000xf64>
    memref.dealloc %4 : memref<1200x1000xf64>
    return %c0_i32 : i32
  }
  func private @init_array(%arg0: i32, %arg1: i32, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?x1200xf64>, %arg5: memref<?x1000xf64>, %arg6: memref<?x1000xf64>) attributes {llvm.linkage = #llvm.linkage<internal>} {
    ...
    memref.store %cst, %arg3[%c0_2] : memref<?xf64>
    ...
    scf.for %arg7 = %c0 to %0 step %c1 {
      ...
      scf.for %arg8 = %c0 to %3 step %c1 {
        ...
        %11 = arith.muli %2, %4 : i32
        %12 = arith.addi %11, %c2_i32 : i32
        %13 = arith.remsi %12, %arg1 : i32
        %14 = arith.sitofp %13 : i32 to f64
        %15 = arith.sitofp %arg1 : i32 to f64
        %16 = arith.divf %14, %15 : f64
        memref.store %16, %arg6[%arg7, %arg8] : memref<?x1000xf64>
      }
    }
