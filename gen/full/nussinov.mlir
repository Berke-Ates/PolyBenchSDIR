...
#set1 = affine_set<(d0)[s0, s1] : (d0 + s0 - s1 - 1 >= 0)>
...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @kernel_nussinov(%arg0: i32, %arg1: !llvm.ptr<i8>, %arg2: memref<?x2500xi32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg3 = 0 to %0 {
      ...
      affine.for %arg4 = #map0(%arg3)[%0] to %2 {
        %10 = arith.index_cast %arg4 : index to i64
        affine.if #set0(%arg4) {
          %12 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<?x2500xi32>
          %13 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg4 - 1] : memref<?x2500xi32>
          %14 = arith.cmpi sge, %12, %13 : i32
          %15 = select %14, %12, %13 : i32
          affine.store %15, %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<?x2500xi32>
        }
        affine.if #set1(%arg3)[%3, %0] {
          %12 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<?x2500xi32>
          %13 = affine.load %arg2[-%arg3 + symbol(%0), %arg4] : memref<?x2500xi32>
          %14 = arith.cmpi sge, %12, %13 : i32
          %15 = select %14, %12, %13 : i32
          affine.store %15, %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<?x2500xi32>
        }
        %11 = affine.if #set0(%arg4) -> i1 {
          %12 = arith.cmpi slt, %9, %arg0 : i32
          affine.yield %12 : i1
        } else {
        ...
        scf.if %11 {
          affine.if #set2(%arg4, %arg3)[%0] {
            %12 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<?x2500xi32>
            %13 = affine.load %arg2[-%arg3 + symbol(%0), %arg4 - 1] : memref<?x2500xi32>
            %14 = arith.subi %5, %7 : i64
            %15 = llvm.getelementptr %arg1[%14] : (!llvm.ptr<i8>, i64) -> !llvm.ptr<i8>
            %16 = llvm.load %15 : !llvm.ptr<i8>
            %17 = arith.extsi %16 : i8 to i32
            %18 = llvm.getelementptr %arg1[%10] : (!llvm.ptr<i8>, i64) -> !llvm.ptr<i8>
            ...
            %25 = arith.cmpi sge, %12, %24 : i32
            %26 = scf.if %25 -> (i32) {
              %27 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<?x2500xi32>
              scf.yield %27 : i32
            } else {
              %27 = affine.load %arg2[-%arg3 + symbol(%0), %arg4 - 1] : memref<?x2500xi32>
              %28 = llvm.load %15 : !llvm.ptr<i8>
              %29 = arith.extsi %28 : i8 to i32
              %30 = llvm.load %18 : !llvm.ptr<i8>
              %31 = arith.extsi %30 : i8 to i32
              %32 = arith.addi %29, %31 : i32
              %33 = arith.cmpi eq, %32, %c3_i32 : i32
              %34 = select %33, %c1_i32, %c0_i32 : i32
              %35 = arith.addi %27, %34 : i32
              scf.yield %35 : i32
            }
            affine.store %26, %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<?x2500xi32>
          } else {
            %12 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<?x2500xi32>
            %13 = affine.load %arg2[-%arg3 + symbol(%0), %arg4 - 1] : memref<?x2500xi32>
            %14 = arith.cmpi sge, %12, %13 : i32
        ...
        affine.for %arg5 = #map0(%arg3)[%0] to #map1(%arg4) {
          %12 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<?x2500xi32>
          %13 = affine.load %arg2[-%arg3 + symbol(%0) - 1, %arg5] : memref<?x2500xi32>
          %14 = affine.load %arg2[%arg5 + 1, %arg4] : memref<?x2500xi32>
          %15 = arith.addi %13, %14 : i32
          %16 = arith.cmpi sge, %12, %15 : i32
          %17 = scf.if %16 -> (i32) {
            scf.yield %12 : i32
          } else {
            %18 = arith.addi %13, %14 : i32
            scf.yield %18 : i32
          }
          affine.store %17, %arg2[-%arg3 + symbol(%0) - 1, %arg4] : memref<?x2500xi32>
        }
      }
    }
    return
