module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %0 = memref.alloc() : memref<150x140x160xf64>
    %1 = memref.alloc() : memref<160xf64>
    %2 = memref.alloc() : memref<160x160xf64>
    %3 = memref.cast %0 : memref<150x140x160xf64> to memref<?x140x160xf64>
    %4 = memref.cast %2 : memref<160x160xf64> to memref<?x160xf64>
    call @init_array(%c150_i32, %c140_i32, %c160_i32, %3, %4) : (i32, i32, i32, memref<?x140x160xf64>, memref<?x160xf64>) -> ()
    %5 = memref.cast %0 : memref<150x140x160xf64> to memref<?x140x160xf64>
    %6 = memref.cast %2 : memref<160x160xf64> to memref<?x160xf64>
    %7 = memref.cast %1 : memref<160xf64> to memref<?xf64>
    call @kernel_doitgen(%c150_i32, %c140_i32, %c160_i32, %5, %6, %7) : (i32, i32, i32, memref<?x140x160xf64>, memref<?x160xf64>, memref<?xf64>) -> ()
    %8 = arith.cmpi sgt, %arg0, %c42_i32 : i32
    %9 = scf.if %8 -> (i1) {
      ...
      %13 = llvm.getelementptr %12[%c0_i32, %c0_i32] : (!llvm.ptr<array<1 x i8>>, i32, i32) -> !llvm.ptr<i8>
      %14 = llvm.call @strcmp(%11, %13) : (!llvm.ptr<i8>, !llvm.ptr<i8>) -> i32
      %15 = arith.trunci %14 : i32 to i1
    ...
    scf.if %9 {
      %10 = memref.cast %0 : memref<150x140x160xf64> to memref<?x140x160xf64>
      call @print_array(%c150_i32, %c140_i32, %c160_i32, %10) : (i32, i32, i32, memref<?x140x160xf64>) -> ()
    }
    memref.dealloc %0 : memref<150x140x160xf64>
    memref.dealloc %1 : memref<160xf64>
    memref.dealloc %2 : memref<160x160xf64>
    return %c0_i32 : i32
  }
  func private @init_array(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<?x140x160xf64>, %arg4: memref<?x160xf64>) attributes {llvm.linkage = #llvm.linkage<internal>} {
  ...
  func @kernel_doitgen(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<?x140x160xf64>, %arg4: memref<?x160xf64>, %arg5: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
      ...
      affine.for %arg7 = 0 to %0 {
        affine.for %arg8 = 0 to %1 {
          ...
          affine.for %arg9 = 0 to %1 {
            %4 = affine.load %arg3[%arg6, %arg7, %arg9] : memref<?x140x160xf64>
            %5 = affine.load %arg4[%arg9, %arg8] : memref<?x160xf64>
            %6 = arith.mulf %4, %5 : f64
            %7 = affine.load %arg5[%arg8] : memref<?xf64>
            %8 = arith.addf %7, %6 : f64
            affine.store %8, %arg5[%arg8] : memref<?xf64>
          }
        }
        affine.for %arg8 = 0 to %2 {
          %4 = affine.load %arg5[%arg8] : memref<?xf64>
          affine.store %4, %arg3[%arg6, %arg7, %arg8] : memref<?x140x160xf64>
        }
      }
    }
    return
  }
  func private @print_array(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<?x140x160xf64>) attributes {llvm.linkage = #llvm.linkage<internal>} {
    %c1 = arith.constant 1 : index
    %c0 = arith.constant 0 : index
    ...
    scf.for %arg4 = %c0 to %12 step %c1 {
      ...
      scf.for %arg5 = %c0 to %26 step %c1 {
        ...
        scf.for %arg6 = %c0 to %28 step %c1 {
          %29 = arith.index_cast %arg6 : index to i32
          %30 = arith.muli %25, %arg1 : i32
          %31 = arith.muli %30, %arg2 : i32
          %32 = arith.muli %27, %arg2 : i32
          ...
          %41 = memref.load %arg3[%arg4, %arg5, %arg6] : memref<?x140x160xf64>
