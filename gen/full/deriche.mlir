module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %8 = affine.load %0[0] : memref<1xf32>
  ...
  func private @kernel_deriche(%arg0: i32, %arg1: i32, %arg2: f32, %arg3: memref<?x2160xf32>, %arg4: memref<?x2160xf32>, %arg5: memref<?x2160xf32>, %arg6: memref<?x2160xf32>) attributes {llvm.linkage = #llvm.linkage<internal>} {
    ...
    affine.for %arg7 = 0 to %24 {
      affine.store %cst, %2[0] : memref<1xf32>
      affine.store %cst, %1[0] : memref<1xf32>
      affine.store %cst, %3[0] : memref<1xf32>
      affine.for %arg8 = 0 to %0 {
        %25 = affine.load %arg3[%arg7, %arg8] : memref<?x2160xf32>
        %26 = arith.mulf %13, %25 : f32
        %27 = affine.load %3[0] : memref<1xf32>
        %28 = arith.mulf %18, %27 : f32
        %29 = arith.addf %26, %28 : f32
        %30 = affine.load %2[0] : memref<1xf32>
        %31 = arith.mulf %20, %30 : f32
        %32 = arith.addf %29, %31 : f32
        %33 = affine.load %1[0] : memref<1xf32>
        %34 = arith.mulf %23, %33 : f32
        %35 = arith.addf %32, %34 : f32
        affine.store %35, %arg5[%arg7, %arg8] : memref<?x2160xf32>
        %36 = affine.load %arg3[%arg7, %arg8] : memref<?x2160xf32>
        affine.store %36, %3[0] : memref<1xf32>
        affine.store %30, %1[0] : memref<1xf32>
        %37 = affine.load %arg5[%arg7, %arg8] : memref<?x2160xf32>
        affine.store %37, %2[0] : memref<1xf32>
      }
    }
    return
  }
