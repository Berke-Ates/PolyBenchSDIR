module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %0 = memref.alloc() : memref<1900x2100xf64>
    %1 = memref.alloc() : memref<2100xf64>
    %2 = memref.alloc() : memref<2100xf64>
    %3 = memref.alloc() : memref<1900xf64>
    %4 = memref.cast %0 : memref<1900x2100xf64> to memref<?x2100xf64>
    %5 = memref.cast %1 : memref<2100xf64> to memref<?xf64>
    call @init_array(%c1900_i32, %c2100_i32, %4, %5) : (i32, i32, memref<?x2100xf64>, memref<?xf64>) -> ()
    %6 = memref.cast %0 : memref<1900x2100xf64> to memref<?x2100xf64>
    %7 = memref.cast %1 : memref<2100xf64> to memref<?xf64>
    %8 = memref.cast %2 : memref<2100xf64> to memref<?xf64>
    %9 = memref.cast %3 : memref<1900xf64> to memref<?xf64>
    call @kernel_atax(%c1900_i32, %c2100_i32, %6, %7, %8, %9) : (i32, i32, memref<?x2100xf64>, memref<?xf64>, memref<?xf64>, memref<?xf64>) -> ()
    ...
    scf.if %11 {
      %12 = memref.cast %2 : memref<2100xf64> to memref<?xf64>
      call @print_array(%c2100_i32, %12) : (i32, memref<?xf64>) -> ()
    }
    memref.dealloc %0 : memref<1900x2100xf64>
    memref.dealloc %1 : memref<2100xf64>
    memref.dealloc %2 : memref<2100xf64>
    memref.dealloc %3 : memref<1900xf64>
    return %c0_i32 : i32
  }
  func private @init_array(%arg0: i32, %arg1: i32, %arg2: memref<?x2100xf64>, %arg3: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<internal>} {
  ...
  func private @kernel_atax(%arg0: i32, %arg1: i32, %arg2: memref<?x2100xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<internal>} {
    ...
    affine.for %arg6 = 0 to %3 {
      ...
      affine.for %arg7 = 0 to %0 {
        ...
        %5 = affine.load %arg2[%arg6, %arg7] : memref<?x2100xf64>
      ...
      affine.for %arg7 = 0 to %1 {
        ...
        %7 = arith.mulf %5, %6 : f64
        %8 = arith.addf %4, %7 : f64
        affine.store %8, %arg4[%arg7] : memref<?xf64>
      }
    }
    return
  }
