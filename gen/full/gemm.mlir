module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    call @init_array(%c1000_i32, %c1100_i32, %c1200_i32, %5, %6, %7, %8, %9) : (i32, i32, i32, memref<?xf64>, memref<?xf64>, memref<?x1100xf64>, memref<?x1200xf64>, memref<?x1100xf64>) -> ()
    %10 = affine.load %1[0] : memref<1xf64>
    %11 = affine.load %0[0] : memref<1xf64>
    %12 = memref.cast %2 : memref<1000x1100xf64> to memref<?x1100xf64>
    %13 = memref.cast %3 : memref<1000x1200xf64> to memref<?x1200xf64>
    %14 = memref.cast %4 : memref<1200x1100xf64> to memref<?x1100xf64>
    call @kernel_gemm(%c1000_i32, %c1100_i32, %c1200_i32, %10, %11, %12, %13, %14) : (i32, i32, i32, f64, f64, memref<?x1100xf64>, memref<?x1200xf64>, memref<?x1100xf64>) -> ()
    ...
    scf.if %16 {
      %17 = memref.cast %2 : memref<1000x1100xf64> to memref<?x1100xf64>
      call @print_array(%c1000_i32, %c1100_i32, %17) : (i32, i32, memref<?x1100xf64>) -> ()
    }
  ...
  func private @init_array(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?x1100xf64>, %arg6: memref<?x1200xf64>, %arg7: memref<?x1100xf64>) attributes {llvm.linkage = #llvm.linkage<internal>} {
  ...
  func @kernel_gemm(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: f64, %arg4: f64, %arg5: memref<?x1100xf64>, %arg6: memref<?x1200xf64>, %arg7: memref<?x1100xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg8 = 0 to %3 {
      affine.for %arg9 = 0 to %0 {
        %4 = affine.load %arg5[%arg8, %arg9] : memref<?x1100xf64>
        %5 = arith.mulf %4, %arg4 : f64
        affine.store %5, %arg5[%arg8, %arg9] : memref<?x1100xf64>
      }
      affine.for %arg9 = 0 to %1 {
        affine.for %arg10 = 0 to %2 {
          %4 = affine.load %arg6[%arg8, %arg9] : memref<?x1200xf64>
          %5 = arith.mulf %arg3, %4 : f64
          %6 = affine.load %arg7[%arg9, %arg10] : memref<?x1100xf64>
          %7 = arith.mulf %5, %6 : f64
          %8 = affine.load %arg5[%arg8, %arg10] : memref<?x1100xf64>
          %9 = arith.addf %8, %7 : f64
          affine.store %9, %arg5[%arg8, %arg10] : memref<?x1100xf64>
        }
      }
    }
    return
