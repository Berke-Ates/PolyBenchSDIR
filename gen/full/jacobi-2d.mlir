...
module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %0 = memref.alloc() : memref<1300x1300xf64>
    %1 = memref.alloc() : memref<1300x1300xf64>
    %2 = memref.cast %0 : memref<1300x1300xf64> to memref<?x1300xf64>
    %3 = memref.cast %1 : memref<1300x1300xf64> to memref<?x1300xf64>
    call @init_array(%c1300_i32, %2, %3) : (i32, memref<?x1300xf64>, memref<?x1300xf64>) -> ()
    %4 = memref.cast %0 : memref<1300x1300xf64> to memref<?x1300xf64>
    %5 = memref.cast %1 : memref<1300x1300xf64> to memref<?x1300xf64>
    call @kernel_jacobi_2d(%c500_i32, %c1300_i32, %4, %5) : (i32, i32, memref<?x1300xf64>, memref<?x1300xf64>) -> ()
    ...
    scf.if %7 {
      %8 = memref.cast %0 : memref<1300x1300xf64> to memref<?x1300xf64>
      call @print_array(%c1300_i32, %8) : (i32, memref<?x1300xf64>) -> ()
    }
    memref.dealloc %0 : memref<1300x1300xf64>
    memref.dealloc %1 : memref<1300x1300xf64>
    return %c0_i32 : i32
  }
  func private @init_array(%arg0: i32, %arg1: memref<?x1300xf64>, %arg2: memref<?x1300xf64>) attributes {llvm.linkage = #llvm.linkage<internal>} {
    ...
    scf.for %arg3 = %c0 to %0 step %c1 {
      ...
      scf.for %arg4 = %c0 to %2 step %c1 {
        ...
        %12 = arith.addi %3, %c3_i32 : i32
        %13 = arith.sitofp %12 : i32 to f64
        %14 = arith.mulf %11, %13 : f64
        %15 = arith.addf %14, %cst : f64
        %16 = arith.sitofp %arg0 : i32 to f64
        %17 = arith.divf %15, %16 : f64
        memref.store %17, %arg2[%arg3, %arg4] : memref<?x1300xf64>
      }
    }
    return
  }
    ...
    affine.for %arg4 = 0 to %2 {
      affine.for %arg5 = 1 to #map()[%0] {
        affine.for %arg6 = 1 to #map()[%0] {
          %3 = affine.load %arg2[%arg5, %arg6] : memref<?x1300xf64>
          %4 = affine.load %arg2[%arg5, %arg6 - 1] : memref<?x1300xf64>
          %5 = arith.addf %3, %4 : f64
          %6 = affine.load %arg2[%arg5, %arg6 + 1] : memref<?x1300xf64>
          %7 = arith.addf %5, %6 : f64
          %8 = affine.load %arg2[%arg5 + 1, %arg6] : memref<?x1300xf64>
          %9 = arith.addf %7, %8 : f64
          %10 = affine.load %arg2[%arg5 - 1, %arg6] : memref<?x1300xf64>
          %11 = arith.addf %9, %10 : f64
          %12 = arith.mulf %cst, %11 : f64
          affine.store %12, %arg3[%arg5, %arg6] : memref<?x1300xf64>
        }
      }
      affine.for %arg5 = 1 to #map()[%1] {
        affine.for %arg6 = 1 to #map()[%1] {
          %3 = affine.load %arg3[%arg5, %arg6] : memref<?x1300xf64>
          %4 = affine.load %arg3[%arg5, %arg6 - 1] : memref<?x1300xf64>
          %5 = arith.addf %3, %4 : f64
          %6 = affine.load %arg3[%arg5, %arg6 + 1] : memref<?x1300xf64>
          %7 = arith.addf %5, %6 : f64
          %8 = affine.load %arg3[%arg5 + 1, %arg6] : memref<?x1300xf64>
          %9 = arith.addf %7, %8 : f64
          %10 = affine.load %arg3[%arg5 - 1, %arg6] : memref<?x1300xf64>
          %11 = arith.addf %9, %10 : f64
          %12 = arith.mulf %cst, %11 : f64
          affine.store %12, %arg2[%arg5, %arg6] : memref<?x1300xf64>
        }
      }
    }
    return
  }
  func private @print_array(%arg0: i32, %arg1: memref<?x1300xf64>) attributes {llvm.linkage = #llvm.linkage<internal>} {
    %c1 = arith.constant 1 : index
    %c0 = arith.constant 0 : index
    ...
    scf.for %arg2 = %c0 to %12 step %c1 {
      ...
      scf.for %arg3 = %c0 to %26 step %c1 {
        ...
        %36 = memref.load %arg1[%arg2, %arg3] : memref<?x1300xf64>
