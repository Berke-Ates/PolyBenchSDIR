  ...
  func @kernel_2mm(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: i32, %arg4: f64, %arg5: f64, %arg6: memref<?x900xf64>, %arg7: memref<?x1100xf64>, %arg8: memref<?x900xf64>, %arg9: memref<?x1200xf64>, %arg10: memref<?x1200xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg11 = 0 to %4 {
      affine.for %arg12 = 0 to %0 {
        ...
        affine.for %arg13 = 0 to %1 {
          %6 = affine.load %arg7[%arg11, %arg13] : memref<?x1100xf64>
          %7 = arith.mulf %arg4, %6 : f64
          %8 = affine.load %arg8[%arg13, %arg12] : memref<?x900xf64>
          %9 = arith.mulf %7, %8 : f64
          %10 = affine.load %arg6[%arg11, %arg12] : memref<?x900xf64>
          %11 = arith.addf %10, %9 : f64
          affine.store %11, %arg6[%arg11, %arg12] : memref<?x900xf64>
        }
      }
    }
    ...
    affine.for %arg11 = 0 to %5 {
      affine.for %arg12 = 0 to %2 {
        %6 = affine.load %arg10[%arg11, %arg12] : memref<?x1200xf64>
        %7 = arith.mulf %6, %arg5 : f64
        affine.store %7, %arg10[%arg11, %arg12] : memref<?x1200xf64>
        affine.for %arg13 = 0 to %3 {
          %8 = affine.load %arg6[%arg11, %arg13] : memref<?x900xf64>
          %9 = affine.load %arg9[%arg13, %arg12] : memref<?x1200xf64>
          %10 = arith.mulf %8, %9 : f64
          %11 = affine.load %arg10[%arg11, %arg12] : memref<?x1200xf64>
          %12 = arith.addf %11, %10 : f64
          affine.store %12, %arg10[%arg11, %arg12] : memref<?x1200xf64>
        }
      }
    }
    return
