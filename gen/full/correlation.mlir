  ...
  func private @kernel_correlation(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x1200xf64>, %arg4: memref<?x1200xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<internal>} {
    ...
    affine.for %arg7 = 0 to %7 {
      ...
      affine.for %arg8 = 0 to %0 {
        %13 = affine.load %arg3[%arg8, %arg7] : memref<?x1200xf64>
    ...
    affine.for %arg7 = 0 to %8 {
      ...
      affine.for %arg8 = 0 to %1 {
        %16 = affine.load %arg3[%arg8, %arg7] : memref<?x1200xf64>
        %17 = affine.load %arg5[%arg7] : memref<?xf64>
        %18 = arith.subf %16, %17 : f64
        %19 = arith.subf %16, %17 : f64
        %20 = arith.mulf %18, %19 : f64
        %21 = affine.load %arg6[%arg7] : memref<?xf64>
        %22 = arith.addf %21, %20 : f64
        affine.store %22, %arg6[%arg7] : memref<?xf64>
      }
      %11 = affine.load %arg6[%arg7] : memref<?xf64>
      %12 = arith.divf %11, %arg2 : f64
      %13 = math.sqrt %12 : f64
      %14 = arith.cmpf ule, %13, %cst_1 : f64
      %15 = select %14, %cst, %13 : f64
    ...
    affine.for %arg7 = 0 to %9 {
      affine.for %arg8 = 0 to %2 {
        ...
        %12 = affine.load %arg3[%arg7, %arg8] : memref<?x1200xf64>
        %13 = arith.subf %12, %11 : f64
        affine.store %13, %arg3[%arg7, %arg8] : memref<?x1200xf64>
        %14 = affine.load %arg6[%arg8] : memref<?xf64>
        %15 = arith.mulf %10, %14 : f64
        %16 = arith.divf %13, %15 : f64
        affine.store %16, %arg3[%arg7, %arg8] : memref<?x1200xf64>
      }
    }
    affine.for %arg7 = 0 to #map0()[%3] {
      ...
      affine.for %arg8 = #map1(%arg7) to %4 {
        ...
        affine.for %arg9 = 0 to %5 {
          %12 = affine.load %arg3[%arg9, %arg7] : memref<?x1200xf64>
          %13 = affine.load %arg3[%arg9, %arg8] : memref<?x1200xf64>
          %14 = arith.mulf %12, %13 : f64
          %15 = affine.load %arg4[%arg7, %arg8] : memref<?x1200xf64>
          %16 = arith.addf %15, %14 : f64
          affine.store %16, %arg4[%arg7, %arg8] : memref<?x1200xf64>
        }
        %11 = affine.load %arg4[%arg7, %arg8] : memref<?x1200xf64>
        affine.store %11, %arg4[%arg8, %arg7] : memref<?x1200xf64>
      }
    }
    affine.store %cst, %arg4[symbol(%6) - 1, symbol(%6) - 1] : memref<?x1200xf64>
    return
  }
