module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %0 = memref.alloc() : memref<2800x2800xi32>
    %1 = memref.cast %0 : memref<2800x2800xi32> to memref<?x2800xi32>
    call @init_array(%c2800_i32, %1) : (i32, memref<?x2800xi32>) -> ()
    %2 = memref.cast %0 : memref<2800x2800xi32> to memref<?x2800xi32>
    call @kernel_floyd_warshall(%c2800_i32, %2) : (i32, memref<?x2800xi32>) -> ()
    ...
    scf.if %4 {
      %5 = memref.cast %0 : memref<2800x2800xi32> to memref<?x2800xi32>
      call @print_array(%c2800_i32, %5) : (i32, memref<?x2800xi32>) -> ()
    }
    memref.dealloc %0 : memref<2800x2800xi32>
    return %c0_i32 : i32
  }
  func private @init_array(%arg0: i32, %arg1: memref<?x2800xi32>) attributes {llvm.linkage = #llvm.linkage<internal>} {
  ...
  func private @print_array(%arg0: i32, %arg1: memref<?x2800xi32>) attributes {llvm.linkage = #llvm.linkage<internal>} {
    %c1 = arith.constant 1 : index
    %c0 = arith.constant 0 : index
    ...
    scf.for %arg2 = %c0 to %12 step %c1 {
      ...
      scf.for %arg3 = %c0 to %26 step %c1 {
        ...
        %34 = llvm.mlir.addressof @str5 : !llvm.ptr<array<4 x i8>>
        %35 = llvm.getelementptr %34[%c0_i32, %c0_i32] : (!llvm.ptr<array<4 x i8>>, i32, i32) -> !llvm.ptr<i8>
        %36 = memref.load %arg1[%arg2, %arg3] : memref<?x2800xi32>
