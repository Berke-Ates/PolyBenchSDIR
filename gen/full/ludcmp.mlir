  ...
  func private @kernel_ludcmp(%arg0: i32, %arg1: memref<?x2000xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<internal>} {
    ...
    affine.for %arg5 = 0 to %3 {
      affine.for %arg6 = 0 to #map0(%arg5) {
        ...
        affine.store %5, %2[0] : memref<1xf64>
        affine.for %arg7 = 0 to #map0(%arg6) {
          %9 = affine.load %arg1[%arg5, %arg7] : memref<?x2000xf64>
          %10 = affine.load %arg1[%arg7, %arg6] : memref<?x2000xf64>
          %11 = arith.mulf %9, %10 : f64
          %12 = affine.load %2[0] : memref<1xf64>
          %13 = arith.subf %12, %11 : f64
          affine.store %13, %2[0] : memref<1xf64>
        }
        %6 = affine.load %2[0] : memref<1xf64>
        %7 = affine.load %arg1[%arg6, %arg6] : memref<?x2000xf64>
        %8 = arith.divf %6, %7 : f64
        affine.store %8, %arg1[%arg5, %arg6] : memref<?x2000xf64>
      }
      affine.for %arg6 = #map0(%arg5) to %3 {
        %5 = affine.load %arg1[%arg5, %arg6] : memref<?x2000xf64>
        affine.store %5, %2[0] : memref<1xf64>
        affine.for %arg7 = 0 to #map0(%arg5) {
          %7 = affine.load %arg1[%arg5, %arg7] : memref<?x2000xf64>
          %8 = affine.load %arg1[%arg7, %arg6] : memref<?x2000xf64>
          %9 = arith.mulf %7, %8 : f64
          %10 = affine.load %2[0] : memref<1xf64>
          %11 = arith.subf %10, %9 : f64
          affine.store %11, %2[0] : memref<1xf64>
        }
        %6 = affine.load %2[0] : memref<1xf64>
        affine.store %6, %arg1[%arg5, %arg6] : memref<?x2000xf64>
      }
    }
    %4 = arith.index_cast %arg0 : i32 to index
    affine.for %arg5 = 0 to %4 {
      ...
      affine.store %5, %2[0] : memref<1xf64>
      affine.for %arg6 = 0 to #map0(%arg5) {
        %7 = affine.load %arg1[%arg5, %arg6] : memref<?x2000xf64>
        %8 = affine.load %arg4[%arg6] : memref<?xf64>
        %9 = arith.mulf %7, %8 : f64
        %10 = affine.load %2[0] : memref<1xf64>
        %11 = arith.subf %10, %9 : f64
        affine.store %11, %2[0] : memref<1xf64>
      ...
      %6 = affine.load %2[0] : memref<1xf64>
      affine.store %6, %arg4[%arg5] : memref<?xf64>
    }
    affine.for %arg5 = 0 to %0 {
      %5 = affine.load %arg4[-%arg5 + symbol(%0) - 1] : memref<?xf64>
      affine.store %5, %2[0] : memref<1xf64>
      affine.for %arg6 = #map1(%arg5)[%0] to %1 {
        %9 = affine.load %arg1[-%arg5 + symbol(%0) - 1, %arg6] : memref<?x2000xf64>
        %10 = affine.load %arg3[%arg6] : memref<?xf64>
        %11 = arith.mulf %9, %10 : f64
        %12 = affine.load %2[0] : memref<1xf64>
        %13 = arith.subf %12, %11 : f64
        affine.store %13, %2[0] : memref<1xf64>
      ...
      %6 = affine.load %2[0] : memref<1xf64>
      %7 = affine.load %arg1[-%arg5 + symbol(%0) - 1, -%arg5 + symbol(%0) - 1] : memref<?x2000xf64>
      %8 = arith.divf %6, %7 : f64
