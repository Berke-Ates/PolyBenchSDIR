    ...
    affine.for %arg12 = 0 to %6 {
      affine.for %arg13 = 0 to %0 {
        ...
        affine.for %arg14 = 0 to %1 {
          %9 = affine.load %arg6[%arg12, %arg14] : memref<?x1000xf64>
          %10 = affine.load %arg7[%arg14, %arg13] : memref<?x900xf64>
          %11 = arith.mulf %9, %10 : f64
          %12 = affine.load %arg5[%arg12, %arg13] : memref<?x900xf64>
          %13 = arith.addf %12, %11 : f64
          affine.store %13, %arg5[%arg12, %arg13] : memref<?x900xf64>
        }
      }
    }
    ...
    affine.for %arg12 = 0 to %7 {
      affine.for %arg13 = 0 to %2 {
        ...
        affine.for %arg14 = 0 to %3 {
          %9 = affine.load %arg9[%arg12, %arg14] : memref<?x1200xf64>
          %10 = affine.load %arg10[%arg14, %arg13] : memref<?x1100xf64>
          %11 = arith.mulf %9, %10 : f64
          %12 = affine.load %arg8[%arg12, %arg13] : memref<?x1100xf64>
          %13 = arith.addf %12, %11 : f64
          affine.store %13, %arg8[%arg12, %arg13] : memref<?x1100xf64>
        }
      }
    }
    ...
    affine.for %arg12 = 0 to %8 {
      affine.for %arg13 = 0 to %4 {
        ...
        affine.for %arg14 = 0 to %5 {
          %9 = affine.load %arg5[%arg12, %arg14] : memref<?x900xf64>
          %10 = affine.load %arg8[%arg14, %arg13] : memref<?x1100xf64>
          %11 = arith.mulf %9, %10 : f64
          %12 = affine.load %arg11[%arg12, %arg13] : memref<?x1100xf64>
          %13 = arith.addf %12, %11 : f64
          affine.store %13, %arg11[%arg12, %arg13] : memref<?x1100xf64>
        }
      }
    }
    return
