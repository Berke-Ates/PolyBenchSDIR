module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %3 = memref.cast %1 : memref<2000xf64> to memref<?xf64>
    call @init_array(%c2000_i32, %2, %3) : (i32, memref<?xf64>, memref<?xf64>) -> ()
    %4 = memref.cast %0 : memref<2000xf64> to memref<?xf64>
    %5 = memref.cast %1 : memref<2000xf64> to memref<?xf64>
    call @kernel_jacobi_1d(%c500_i32, %c2000_i32, %4, %5) : (i32, i32, memref<?xf64>, memref<?xf64>) -> ()
    ...
    scf.if %7 {
      %8 = memref.cast %0 : memref<2000xf64> to memref<?xf64>
      call @print_array(%c2000_i32, %8) : (i32, memref<?xf64>) -> ()
    }
    memref.dealloc %0 : memref<2000xf64>
    memref.dealloc %1 : memref<2000xf64>
    return %c0_i32 : i32
  }
  func private @init_array(%arg0: i32, %arg1: memref<?xf64>, %arg2: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<internal>} {
    ...
    scf.for %arg3 = %c0 to %0 step %c1 {
      ...
      memref.store %9, %arg2[%arg3] : memref<?xf64>
    }
    return
  }
  func @kernel_jacobi_1d(%arg0: i32, %arg1: i32, %arg2: memref<?xf64>, %arg3: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
