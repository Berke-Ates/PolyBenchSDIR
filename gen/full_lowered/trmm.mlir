module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %4 = memref.cast %1 : memref<1000x1000xf64> to memref<?x1000xf64>
    %5 = memref.cast %2 : memref<1000x1200xf64> to memref<?x1200xf64>
    call @init_array(%c1000_i32, %c1200_i32, %3, %4, %5) : (i32, i32, memref<?xf64>, memref<?x1000xf64>, memref<?x1200xf64>) -> ()
    %c0 = arith.constant 0 : index
    %6 = memref.load %0[%c0] : memref<1xf64>
    %7 = memref.cast %1 : memref<1000x1000xf64> to memref<?x1000xf64>
    %8 = memref.cast %2 : memref<1000x1200xf64> to memref<?x1200xf64>
    call @kernel_trmm(%c1000_i32, %c1200_i32, %6, %7, %8) : (i32, i32, f64, memref<?x1000xf64>, memref<?x1200xf64>) -> ()
    ...
    scf.if %10 {
      %11 = memref.cast %2 : memref<1000x1200xf64> to memref<?x1200xf64>
      call @print_array(%c1000_i32, %c1200_i32, %11) : (i32, i32, memref<?x1200xf64>) -> ()
    }
    memref.dealloc %1 : memref<1000x1000xf64>
    memref.dealloc %2 : memref<1000x1200xf64>
    return %c0_i32 : i32
  }
  func private @init_array(%arg0: i32, %arg1: i32, %arg2: memref<?xf64>, %arg3: memref<?x1000xf64>, %arg4: memref<?x1200xf64>) attributes {llvm.linkage = #llvm.linkage<internal>} {
