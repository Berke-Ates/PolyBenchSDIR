module attributes {llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"}  {
  ...
  func @main(%arg0: i32, %arg1: !llvm.ptr<ptr<i8>>) -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %2 = memref.alloc() : memref<1300x1300xf64>
    %3 = memref.alloc() : memref<1300x1300xf64>
    %4 = memref.alloc() : memref<1300xf64>
    %5 = memref.alloc() : memref<1300xf64>
    %6 = memref.alloc() : memref<1300xf64>
    %7 = memref.cast %1 : memref<1xf64> to memref<?xf64>
    %8 = memref.cast %0 : memref<1xf64> to memref<?xf64>
    %9 = memref.cast %2 : memref<1300x1300xf64> to memref<?x1300xf64>
    %10 = memref.cast %3 : memref<1300x1300xf64> to memref<?x1300xf64>
    %11 = memref.cast %5 : memref<1300xf64> to memref<?xf64>
    call @init_array(%c1300_i32, %7, %8, %9, %10, %11) : (i32, memref<?xf64>, memref<?xf64>, memref<?x1300xf64>, memref<?x1300xf64>, memref<?xf64>) -> ()
    %c0 = arith.constant 0 : index
    %12 = memref.load %1[%c0] : memref<1xf64>
    %c0_0 = arith.constant 0 : index
    %13 = memref.load %0[%c0_0] : memref<1xf64>
    %14 = memref.cast %2 : memref<1300x1300xf64> to memref<?x1300xf64>
    %15 = memref.cast %3 : memref<1300x1300xf64> to memref<?x1300xf64>
    %16 = memref.cast %4 : memref<1300xf64> to memref<?xf64>
    %17 = memref.cast %5 : memref<1300xf64> to memref<?xf64>
    %18 = memref.cast %6 : memref<1300xf64> to memref<?xf64>
    call @kernel_gesummv(%c1300_i32, %12, %13, %14, %15, %16, %17, %18) : (i32, f64, f64, memref<?x1300xf64>, memref<?x1300xf64>, memref<?xf64>, memref<?xf64>, memref<?xf64>) -> ()
    %19 = arith.cmpi sgt, %arg0, %c42_i32 : i32
    %20 = scf.if %19 -> (i1) {
      %21 = llvm.getelementptr %arg1[%c0_i64] : (!llvm.ptr<ptr<i8>>, i64) -> !llvm.ptr<ptr<i8>>
      %22 = llvm.load %21 : !llvm.ptr<ptr<i8>>
      %23 = llvm.mlir.addressof @str0 : !llvm.ptr<array<1 x i8>>
      %24 = llvm.getelementptr %23[%c0_i32, %c0_i32] : (!llvm.ptr<array<1 x i8>>, i32, i32) -> !llvm.ptr<i8>
      %25 = llvm.call @strcmp(%22, %24) : (!llvm.ptr<i8>, !llvm.ptr<i8>) -> i32
      %26 = arith.trunci %25 : i32 to i1
    ...
    scf.if %20 {
      %21 = memref.cast %6 : memref<1300xf64> to memref<?xf64>
      call @print_array(%c1300_i32, %21) : (i32, memref<?xf64>) -> ()
    }
    memref.dealloc %2 : memref<1300x1300xf64>
    memref.dealloc %3 : memref<1300x1300xf64>
    memref.dealloc %4 : memref<1300xf64>
    memref.dealloc %5 : memref<1300xf64>
    memref.dealloc %6 : memref<1300xf64>
    return %c0_i32 : i32
  }
  func private @init_array(%arg0: i32, %arg1: memref<?xf64>, %arg2: memref<?xf64>, %arg3: memref<?x1300xf64>, %arg4: memref<?x1300xf64>, %arg5: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<internal>} {
    ...
    memref.store %cst_0, %arg1[%c0_1] : memref<?xf64>
    %c0_2 = arith.constant 0 : index
    memref.store %cst, %arg2[%c0_2] : memref<?xf64>
    ...
    scf.for %arg6 = %c0 to %0 step %c1 {
      ...
      scf.for %arg7 = %c0 to %6 step %c1 {
        ...
        memref.store %13, %arg3[%arg6, %arg7] : memref<?x1300xf64>
        %14 = arith.muli %1, %7 : i32
        ...
        memref.store %19, %arg4[%arg6, %arg7] : memref<?x1300xf64>
      }
    }
    return
  }
